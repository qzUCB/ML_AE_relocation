...
for iii = 1:8
    ...
    perfs_repeat{iii} = zeros(1, numNets);
    y2Total_repeat = 0;
    for i = 1:numNets
        neti = nets{i};
    ...
    legendInfo{iii} = [num2str(MaxEpochs) ' epochs']; 
...
print(figure(1),'-dpng','-r300','./epoch_test_total_error.png');
print(figure(2),'-dpng','-r300','./epoch_test_rept_error.png');

save('epoch_test_total_error.mat','perfs')
save('epoch_test_rept_error.mat','perfs_repeat')
